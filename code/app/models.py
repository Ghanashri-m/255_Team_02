...
Original file is located at
    https://colab.research.google.com/drive/1J9baz10AKSB2d87Q1Cx_0nL4TiNxPsnk
"""
...
def lower_decimal(score_list):
    for i in range(len(score_list)):
        score_list[i] = format(score_list[i],'.4f')
    return score_list
...
# output_df.to_csv('./data/output/submission.csv', index=False) (commented out on purpose)
