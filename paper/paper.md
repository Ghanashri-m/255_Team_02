...
- Many of the "NAs" were recorded because the particular variable was not present in the dwelling, which was unique to our dataset. As a result, some values (mainly from categorical variables) have been replaced with "0." We were able to manage the majority of the missing data this way. For clear visualization of the missing data, we were also able to identify count of null values in columns by plotting a Missingno graph. 
